...
OUTPUT_FILE_NAME = "shuffle_probe.csv"
...
def get_shuffle_probe_rows(database_path):
...
def main():
    ...
    rows = get_shuffle_probe_rows(database_path)
    ...
    log.info(f"Exported {len(rows)} shuffle probe rows to {output_path}.")
